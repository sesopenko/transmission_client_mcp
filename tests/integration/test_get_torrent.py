...
class TestGetTorrentIntegration:
    def test_get_torrent_returns_expected_fields(
    ...
    def test_get_torrent_case_insensitive_match(self, transmission_client: Client, torrent_queue: TorrentQueue) -> None:
